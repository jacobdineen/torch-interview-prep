...
from p38_gradient_accumulation import *

def test_p38_gradient_accumulation():
    ...
    with step("returned total equals sum of un-scaled per-batch losses"):
        expected_total = sum(loss_fn(ref_model, b[0], b[1]).item() for b in micro)
