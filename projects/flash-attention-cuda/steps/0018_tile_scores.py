"""
Step 0018: tile_scores

Part 5 — Tiled Attention Building Blocks
Tile-level scaled scores: scale * Q @ K^T.
...
You edit the CUDA inside the tile_scores string below. The host function must stay
named `tile_scores` and keep its signature: torch::Tensor tile_scores(torch::Tensor,torch::Tensor,double)
"""
tile_scores = r'''#include <torch/extension.h>
