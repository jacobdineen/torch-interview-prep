"""
Step 0019: tile_rowmax

Part 5 — Tiled Attention Building Blocks
Row max of a score tile -> (R,).
...
You edit the CUDA inside the tile_rowmax string below. The host function must stay
named `tile_rowmax` and keep its signature: torch::Tensor tile_rowmax(torch::Tensor)
"""
tile_rowmax = r'''#include <torch/extension.h>
